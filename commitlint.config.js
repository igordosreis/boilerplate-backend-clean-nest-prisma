const matchAnyType =
  /(?<!:)(?::package: build|:wrench: chore|:bricks: ci|:books: docs|:sparkles: feat|:bug: fix|:zap: perf|:recycle: refactor|:boom: revert|:ok_hand: style|:test_tube: test|build|chore|ci|docs|feat|fix|perf|refactor|revert|style|test)\b(?!_)/;
